default['zookeeper']['log4j']['zookeeper.root.logger'] = 'INFO, ROLLINGFILE'
...
default['zookeeper']['log4j']['zookeeper.log.threshold'] = 'INFO'
...
default['zookeeper']['log4j']['log4j.appender.ROLLINGFILE.MaxBackupIndex'] = '25'
